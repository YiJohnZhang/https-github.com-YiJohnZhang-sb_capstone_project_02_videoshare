...
INSERT INTO users("username","first_name","last_name","birthdate","verified","account_status","email","password","picture","description","is_elevated")
	...
	('webbmark','Sheila','Marks','2003-5-21',TRUE,'active','lauraconner@hotmail.com','$2a$14$3QlPlVm0blm4M5sLgUmcc.ii6DLtVW6S6AOWRn3rWNZhwBVsWzq/K','xsgamesf-56.jpg','Term left view.',FALSE),
	('vsokolova','Leonre','Sokolova','1991-9-5',TRUE,'active','bookerricky@gmail.com','$2a$14$3QlPlVm0blm4M5sLgUmcc.ii6DLtVW6S6AOWRn3rWNZhwBVsWzq/K','xsgamesf-38.jpg','Arrive indicate finally.',FALSE),
...
INSERT INTO contents(title,summary,description,link,status,owner,contract_type,participants,contract_details,contract_signed,date_created,date_standby,date_published)
	...
	('Talent Dredge','m&w2','Again, one of my favorites from the masters, Mitchell and Webb.','3I5udb-BDAQ','published','thatmitchellandwebblook','presplit','["thatmitchellandwebblook", "vsokolova"]','{"views":[{"username": "thatmitchellandwebblook", "share":0.7}, {"username": "vsokolova", "share":0.3}], "engagement":[{"username": "thatmitchellandwebblook", "share":0.5}, {"username": "vsokolova", "share":0.5}]}','["thatmitchellandwebblook", "vsokolova"]','2022-12-12','2022-12-26','2022-12-27'),
	...
	('Lorem Ipsum','placeh0lder','Lorem ispum.',NULL,'standby','tiffanywilson','presplit','["tiffanywilson"]','{"views":[{"username": "tiffanywilson", "share":1}], "engagement":[{"username": "tiffanywilson", "share":1}]}','["tiffanywilson"]','2022-12-12','2022-12-26',NULL),
	('Birdie','placeholder','Ispum et Dolor.',NULL,'open','vsokolova','presplit','["vsokolova"]','{"views":[{"username": "vsokolova", "share":1}], "engagement":[{"username": "vsokolova", "share":1}]}','["vsokolova"]','2022-12-12',NULL,NULL),
	...
	('Cazzette - Weapon (Vicetone Remix)','a remix','"Weapon" by Cazzette, a Swedish EDM Duo, Remixed by Vicetone, a Dutch EDM Duo.','tckmAl_P8dg','published','shawn89','presplit','["shawn89", "andersontroy"]','{"views":[{"username": "shawn89", "share":0.9}, {"username": "andersontroy", "share":0.1}], "engagement":[{"username": "shawn89", "share":0.4}, {"username": "andersontroy", "share":0.6}]}','["shawn89", "andersontroy"]','2022-12-19','2022-12-20','2022-12-21');
...
INSERT INTO contents_users_join(user_id,content_id,description)
	...
	('shawn89',11,'"Weapon" by Cazzette, a Swedish EDM Duo, Remixed by Vicetone, a Danish EDM Duo.'),
	('andersontroy',11,'"Weapon" by Cazzette, a Swedish EDM Duo, Remixed by Vicetone, a Danish EDM Duo.'),
