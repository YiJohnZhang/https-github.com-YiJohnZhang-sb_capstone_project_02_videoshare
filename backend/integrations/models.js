...
class pgModel{
	...
	static relationName;
	constructor(relationName, QUERY_GENERAL_PROPERTIES, QUERY_PRIVATE_PROPERTIES, JSON_SQL_MAPPING, JSON_SQl_QUERY_MAPPING){

		this.constructor.relationName = relationName;
		this.QUERY_GENERAL_PROPERTIES = QUERY_GENERAL_PROPERTIES;
		this.QUERY_PRIVATE_PROPERTIES = QUERY_PRIVATE_PROPERTIES;
		this.JSON_SQL_MAPPING = JSON_SQL_MAPPING;
		this.JSON_SQL_QUERY_MAPPING = JSON_SQL_QUERY_MAPPING;		
